  ...
  <div id="app-customizer" class="app-customizer">
    ...
    <div class="customizer-tabs">
      ...
      <ul class="nav nav-tabs" role="tablist">
        <li role="presentation" class="active"><a href="#menubar-customizer" aria-controls="menubar-customizer" role="tab" data-toggle="tab">Sidebar</a></li>
      ...
      <div class="tab-content">
        <div role="tabpanel" class="tab-pane in active fade" id="menubar-customizer">
          ...
          <div class="radio radio-default m-b-md">
            ...
            <label for="menubar-light-theme">Light Mode</label>
          </div>
          ...
          <div class="radio radio-inverse m-b-md">
            ...
            <label for="menubar-dark-theme">Dark Mode</label>
          </div>
        </div><!-- .tab-pane -->
