...
$("#facultylist").html(data);
  ...
  <div class="grid-item">
    <img src="images/title/logo.jpg" alt="Image 1">
  ...
  <div class="grid-item">
    <img src="images/title/logo.jpg" alt="Image 2">
    <div class="grid-item-content">
  ...
  <div class="grid-item">
    <img src="images/title/logo.jpg" alt="Image 4">
    <div class="grid-item-content">
      <h2>Robotics</h2>
      <p>Engr. Fagela </p>
    </div>
  ...
  <div class="grid-item">
    <img src="images/title/logo.jpg" alt="Image 3">
    <div class="grid-item-content">
